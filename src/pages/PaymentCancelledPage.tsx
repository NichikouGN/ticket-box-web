  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-red-600 rounded-full blur-[160px] opacity-8" />
        <div className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-violet-600 rounded-full blur-[160px] opacity-8" />
      </div>
